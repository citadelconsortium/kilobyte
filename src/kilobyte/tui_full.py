...
class KiloApp:
    ...
    def _answer_line(self, text: str) -> None:
        ...
        Leading blank tokens are discarded and repeated blank lines collapse to one.
        This keeps a reasoning pause from growing empty rows inside the response box while
        preserving one deliberate paragraph break after real answer text.
        """
        if not text.strip():
