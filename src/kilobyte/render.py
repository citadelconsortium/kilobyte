...
class MarkdownStream:
    ...
    def _format_line(self, line: str) -> str | None:
        ...
        if self._in_code:
            # Buffer a fenced block so Pygments sees enough context to colour names,
            # strings, comments and keywords accurately rather than painting it all cyan.
    ...
    def feed(self, chunk: str) -> str:
        ...
        while "\n" in self._buffer:
            ...
            # Small local models often begin every continuation with blank tokens. They
            # used to accumulate as empty rows after each tool. Preserve intentional
            # paragraph breaks once visible content has begun.
